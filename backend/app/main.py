...
from app.routers import auth, users, resumes, job_descriptions, mock_sessions, mock_session_answers, file_parser, user_metrics
...
app.add_middleware(
    CORSMiddleware,
    allow_origins=["http://localhost:5173","https://mockr-abc.vercel.app/"],  # Frontend URL
